...
export function QuestionTabs({
    ...
    return (
        <div className={`w-full md:w-48 flex-shrink-0 flex flex-row md:flex-col gap-2 overflow-x-auto md:overflow-visible pb-2 md:pb-0 z-10 bg-white md:bg-transparent sticky top-4 h-fit`}>
            {questions.map((q, idx) => (
                <button
                    key={q.id}
                    type="button"
