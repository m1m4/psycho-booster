...
function PreviewImage({
    ...
    if (hasError) {
        return (
            <div className={`flex flex-col items-center justify-center bg-gray-100 dark:bg-gray-800 border-2 border-dashed border-gray-300 dark:border-gray-700 rounded-lg p-4 text-center ${className}`}>
                                ...
                                {getQuestionImageSource(currentQuestion, 'question') && (
                                    <div className="mt-4 flex justify-center">
                                        <PreviewImage
                                            ...
                                            alt="Question"
                                            className="max-h-80 h-auto w-auto object-contain rounded-lg cursor-zoom-in hover:opacity-90 transition-opacity p-2 border border-gray-100 dark:border-gray-800"
                                            onClick={setLightboxImage}
                                            useCors={isExport}
                                        />
                                    </div>
