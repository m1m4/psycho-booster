...
export function Preview({ formData, isEnglish }: PreviewProps) {
    ...
    const showAssetData = assetFile || assetText;
    ...
    const renderAsset = () => {
        ...
        const imageElement = assetFile && (
            <img
                ...
                onClick={() => setLightboxImage(URL.createObjectURL(assetFile))}
                title="Click to zoom"
            />
        );
                            ...
                            {currentQuestion.questionImage && (
                                <div className="mt-6 flex justify-center p-4 rounded-xl bg-white dark:bg-black/20 border border-gray-100 dark:border-gray-800/50">
                                    <img
                                        ...
                                        onClick={() => setLightboxImage(URL.createObjectURL(currentQuestion.questionImage!))}
                                    />
                                </div>
                            )}
                        </div>
                                        ...
                                        <div className="flex-1 min-w-0">
                                            {answerImage ? (
                                                <img
                                                    ...
                                                    onClick={() => setLightboxImage(URL.createObjectURL(answerImage))}
                                                />
                                            ) : (
                                                <div
