...
export function QuestionsTable() {
    ...
    const {
        ...
        queryKey: ['questions', sortConfig, filters], // Refetch on filter change
        queryFn: ({ pageParam }) => getPaginatedQuestions(20, pageParam, sortConfig.key, sortConfig.direction, filters),
        ...
        <div className="space-y-4 relative">
            ...
            <div className="flex justify-between items-center bg-white dark:bg-gray-900 p-4 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm">
                <div className="flex items-center gap-4">
                    <h3 className="font-bold text-lg text-gray-800 dark:text-white">רשימת שאלות</h3>
                    {selectedIds.size > 0 && (
